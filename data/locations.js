...
export const LOCATIONS = {
  ...
  courier: {name:'Courier Station', subtitle:'Letters, parcels & winter dispatches', region:'city', travel:45, icon:'letter', dottomons:[], mood:'amber'},
  ...
  guardroom: {name:'Palace Guardroom', subtitle:'Watch rotations & visitor records', region:'palace', travel:30, icon:'shield', dottomons:[], mood:'silver'}
};
